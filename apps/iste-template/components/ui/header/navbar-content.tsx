...
const NavbarContent: React.FC = () => {
  ...
  return (
    <motion.nav
      ...
      initial="hidden"
      whileInView="show"
      className={`md:px-10" glassmorphism absolute z-50 mt-2 flex w-full flex-wrap items-center justify-around gap-2 px-5 text-sm font-medium uppercase opacity-90 ${
